...
import { useGetWbWorkOrderDetail } from "@workspace/api-client-react";
...
export default function WorkOrderDetail() {
  ...
  const { data: wo, isLoading, error } = useGetWbWorkOrderDetail(id!, {
    query: { queryKey: ["getWbWorkOrderDetail", id], enabled: !!id }
  });
